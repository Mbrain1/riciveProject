...
<div className="grid md:grid-cols-2 md:gap-6">
    ...
    <div className="relative z-0 mb-6 w-full group">
        <input type="email"  className="rounded-lg  placeholder-gray-100 text-base w-full border py-3 px-12 border-gray-100  focus:outline-0" placeholder="Email address" />
        <img src="/assets/svgs/mail-dark.svg" alt="Dark Mail" className="absolute left-5 top-4" />
    </div>

    <div className="relative z-0 mb-6 w-full group">
        <input type="tel"  className="rounded-lg  placeholder-gray-100 text-base w-full border py-3 px-12 border-gray-100  focus:outline-0" placeholder="+2348162458925"  />
