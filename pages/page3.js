...
const page2 = (props) => {
  return (
    <>
          ...
          <img src="/assets/svgs/dotted-square.svg" alt="dotted square 1" className="hidden md:block absolute top-10 right-0 z-10" />
      </div>
    ...
    <section className="py-12 relative pb-[200px] md:pb-[300px]">
        ...
        <div className="rounded-3xl shadow-2xl bg-white py-[100px] md:mx-12 space-y-12 my-12 relative z-50 px-5">
            <div className="flex flex-col justify-center items-center space-y-5 order-2 md:px-10">
               <h1 className="text-5xl font-black">Business plans</h1>

               <p className="font-medium text-xl text-center md:w-3/4">
                 A work benefit for great teams. Care for your team even when work week ends, save them hours on weekends.
               </p>

            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-[100px] md:px-12 md:mx-12 ">
