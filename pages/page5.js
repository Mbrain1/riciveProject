  ...
  return (
    <>
      <div className="bg-green-900 relative  overflow-hidden">
            ...
            <nav className="md:flex md:justify-center items-center text-white text-xl overflow-x-auto md:overflow-hidden">
               <ul className="flex space-x-7">
                  <li><a href="#" className="text-green-100 border-b-8  border-green-100 py-4 px-5 inline-block font-medium whitespace-nowrap">Wash & Fold</a></li>
                  <li><a href="#" className="py-4 px-5 inline-block font-medium  whitespace-nowrap">Wash & Iron</a></li>
                  <li><a href="#" className="py-4 px-5 inline-block font-medium whitespace-nowrap">Ironing only</a></li>
                  <li><a href="#" className="py-4 px-5 inline-block font-medium whitespace-nowrap">Drycleaning</a></li>
               </ul>
            </nav>
      </div>
