  ...
  return (
    <>
        <div className="py-12 relative">
           ...
           <div className="container grid grid-cols-1 lg:grid-cols-2 min-h-[80vh] gap-12 z-20 relative">
            ...
            <div className="order-1 space-y-10 flex flex-col justify-center items-center text-center lg:items-start lg:text-left">
             ...
             <div className="flex justify-center order-2  relative ">
              <img src="/assets/images/joyce.png" data-aos="zoom-in-down" />


              <div className="absolute -bottom-20 p-10 text-sm mx-auto rounded-3xl space-y-5 bg-white w-11/12 sm:w-2/3 lg:w-3/4 inset-x-auto" data-aos="zoom-in-down">
          ...
          <img src="/assets/images/background.png" data-aos="zoom-in" />
          <div className="bg-green-900 py-60 lg:py-14"></div>
          </div>
      </div>
     ...
     <section className="py-28 relative -top-0 sm:top-28">

          
           <div className="ml-5 lg:ml-20 ml-auto shadow-2xl rounded-3xl px-5 py-20 sm:py-28 lg:p-28 grid grid-cols-1 lg:grid-cols-2  gap-10 z-20 relative bg-white text-center lg:text-left">
            
            <div className="order-1 flex flex-col relative z-30 " data-aos="fade-right">
             ...
             <div className="flex justify-center  order-2 relative " data-aos="fade-left">
    ...
    <section className="py-12 relative">
        <div className="container grid lg:grid-cols-2 gap-12 relative">
            ...
            <div className="flex flex-col justify-center space-y-10  order-1 lg:order-2" data-aos="fade-left">
            ...
            <div className="flex justify-center  order-2 lg:order-1 relative">
              <img src="/assets/images/mockup/PhoneMockup3.png" className="z-40 relative"  data-aos="fade-right" />


            <div className="rounded-full bg-green-800 absolute w-20 h-20 -bottom-12 right-0  lg:hidden opacity-90" data-aos="fade-up"></div>

            <div className="rounded-full bg-yellow-900 absolute w-20 h-20 -top-5 sm:top-12 right-0  lg:hidden opacity-90" data-aos="fade-up"></div>

             <img src="/assets/svgs/big-green-circle.svg" className="absolute top-0 -left-50 z-10" data-aos="fade-up" />

            </div>

             <div className="rounded-full bg-green-800 absolute w-20 h-20 -bottom-12 right-0  hidden lg:block opacity-90" data-aos="fade-up"></div>

            <div className="rounded-full bg-yellow-900 absolute w-20 h-20 top-12 right-0  hidden lg:block opacity-90" data-aos="fade-up"></div>
    ...
    <section className="py-12 relative">
        <div className="container grid lg:grid-cols-2 gap-12 relative">
            <div className="flex flex-col justify-center space-y-10  order-1" data-aos="fade-right">
            ...
            <div className="flex justify-center justify-center  order-2 relative">
              <img src="/assets/images/mockup/PhoneMockup4.png" className="z-40 relative"  data-aos="fade-left" />


              <img src="/assets/svgs/big-grey-circle.svg" className="absolute top-0 -left-50 lg:-right-10 z-10" data-aos="fade-up" />

               <div className="rounded-full bg-green-800 absolute w-20 h-20 -bottom-12 right-0 lg:hidden  opacity-90 z-20" data-aos="fade-up"></div>

              <div className="rounded-full bg-yellow-900 absolute w-20 h-20 -top-5 sm:top-12 right-0  lg:hidden opacity-90 z-20" data-aos="fade-up"></div>

            </div>


            <div className="rounded-full bg-green-800 absolute w-20 h-20 -bottom-12 left-0 hidden lg:block  opacity-90 z-20" data-aos="fade-up"></div>

              <div className="rounded-full bg-yellow-900 absolute w-20 h-20 top-12 left-0  hidden lg:block opacity-90 z-20" data-aos="fade-up"></div>
        ...
        <div className="container grid lg:grid-cols-2 gap-12 relative">
            ...
            <div className="flex justify-center justify-center  order-2 lg:order-1 relative">
              <img src="/assets/images/mockup/iPhoneX2.png" className="z-40 relative"  data-aos="fade-right" />

              <div className="rounded-full bg-green-800 absolute w-20 h-20 -bottom-12 right-0 lg:hidden  opacity-90" data-aos="fade-up"></div>

               <div className="rounded-full bg-yellow-900 absolute w-20 h-20 -top-5 sm:top-12 right-0  lg:hidden opacity-90" data-aos="fade-up"></div>

                <img src="/assets/svgs/big-green-circle2.svg" className="absolute top-0 -left-50 z-10" data-aos="fade-up" />
