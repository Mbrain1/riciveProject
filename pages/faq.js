...
const Faqs = (props) => {
  return (
    <>
          ...
          <div className="md:px-24 px-8  grid grid-cols-1 min-h-[70vh] py-12 ">
            
            <div className="space-y-10 flex flex-col justify-center items-start relative z-30">

            <h1 className="text-2xl font-semibold relative  z-30 text-orange-500">FAQs</h1>
     ...
     <section className="py-12 relative ">
        <div className="md:px-24 px-8  border-t py-12">
            <div className="space-y-12">
              ...
              <div className="flex justify-center text-variant text-green-100 font-semibold space-x-3">
