 ...
 const PricingWrapper = ({isPricingOpen,isOpen}) => {
    return(
              <div className={`absolute bg-white inset-x-[10px] sm:inset-x-1/4  sm:w-2/4 top-20 z-50 p-7 space-y-10 transition-all duration-300 ${isPricingOpen && isOpen == false ? 'z-[1000] opacity-100' : '-z-50 opacity-0'}`}>
