          ...
          <nav className="flex justify-between items-center container ">
            ...
            <div className="hidden md:flex space-x-3">
             ...
             <button class="block md:hidden py-3 px-4 mx-2 rounded focus:outline-none hover:bg-grey-200 group" onClick={() => setIsOpen(!isOpen)}>
              ...
              <div className={`grid gap-10  absolute bg-white inset-x-[10px] md:inset-x-1/4 ${isPartnerOpen || isBusinessOpen ? 'md:w-3/4 grid-cols-2' : 'md:w-2/4 grid-cols-1'} top-20 z-50 px-7  transition-all duration-100 ${isProductOpen ? 'z-50 opacity-100' : '-z-50 opacity-0'}`}>
